...
configs['net']['hidden_sizes'] = [512, 256, 128]
configs['net']['batchnorms'] = [True, True, True]
configs['net']['dropouts'] = [0.2, 0.2, 0.2, 0.1]   # the first is dropout for input
